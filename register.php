...
if(isset($_POST['register'])){
  ...
  $location_img = "./app/customers/upload/$image_name";
  move_uploaded_file($tmp_name,$location_img); 
  $insert = "INSERT INTO customers VALUES (NULL , '$name','$email','$hash_password','$image_name', DEFAULT)";
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="d-flex justify-content-center py-4 w-100 body-gray">
                  <a href="index.html" class="logo d-flex align-items-center w-auto">
                    <img src="images/logo_motors.svg" alt="">
